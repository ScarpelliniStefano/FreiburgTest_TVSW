...
public class DefaultAppSettingsDoctor {
	...
	public static String suppTestSettings = new JSONObject().put(SuppressionTestJson.left_red, 255)
			.put(SuppressionTestJson.left_blue, 0).put(SuppressionTestJson.left_green, 0).put(SuppressionTestJson.right_red, 0)
			.put(SuppressionTestJson.right_blue, 255).put(SuppressionTestJson.right_green, 0).toString();
