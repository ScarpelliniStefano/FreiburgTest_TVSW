...
public class AngleCalculusTest {
		private static AbstractAngleCalculus calculator;
	 @RunWith(Parameterized.class)
	    public static class ParameterizedTest {
		 	...
		 	public void calcolaAngoloTest() {
		 		int angle=AbstractAngleCalculus.calcolaAngolo(monitorSize,dimenSchermo,XBar,distSchermo);
	    ...
	    public static class NonParameterizedTest {
			...
			public void calcolaAngoloDatiGenTest() {
				int angle=AbstractAngleCalculus.calcolaAngolo(dgen);
