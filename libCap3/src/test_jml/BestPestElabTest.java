...
import fstTest.BestPestElaboratorNew;
import fstTest.PestBase.CertifierStatus;
import fstTest.PestBase.Soluzione;
import fstTest.TestSession.Result;


@RunWith(Enclosed.class)
public class BestPestElabTest {
	BestPestElaboratorNew bpElab=new BestPestElaboratorNew(12, 1);
	    ...
	    public static class ParameterizedTest {
		 BestPestElaboratorNew bpElab=new BestPestElaboratorNew(12, 1);
			...
			public void testComputeNextDepth() {
				...
				System.out.println(bpElab.getCertifierStatus().toString());
			}
	 }
	 public static class NonParameterizedTest {
		 ...
		 public void testBestPestElaborator() {
			 ...
			 for(int[] err:maxMinErr) {
				 ...
				 assertEquals(bpElab.getRightLimit(),1);
			 }
		 }
