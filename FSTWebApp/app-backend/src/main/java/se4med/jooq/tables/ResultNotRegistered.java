...
/**
 * This table contains results about patient registred by doctors
 */
@Generated(
    value = {
        "http://www.jooq.org",
...
public class ResultNotRegistered extends TableImpl<ResultNotRegisteredRecord> {
    ...
    private static final long serialVersionUID = -352924644;
...
se l'id della tabella application viene cancellato e c'è un record che contiene quell'id, non viene permessa la cancellazione dell'applicazione
    ...
    private ResultNotRegistered(Name alias, Table<ResultNotRegisteredRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("This table contains results about patient registred by doctors"));
    }
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.RESULT_NOT_REGISTERED_FK_RESULT_NOT_REGISTERED_1_IDX, Indexes.RESULT_NOT_REGISTERED_FK_RESULT_NOT_REGISTERED_2_IDX, Indexes.RESULT_NOT_REGISTERED_PRIMARY);
    }
    ...
    public List<ForeignKey<ResultNotRegisteredRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<ResultNotRegisteredRecord, ?>>asList(Keys.FK_RESULT_NOT_REGISTERED_2, Keys.FK_RESULT_NOT_REGISTERED_1);
    }

    public Application application() {
        return new Application(this, Keys.FK_RESULT_NOT_REGISTERED_2);
    }
