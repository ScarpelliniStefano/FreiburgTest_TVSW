...
public class Test_session{
	...
	/** the tester. */
	private static BestPestElaborator testElab;
	...
	/**
	 * costruttore
	 * @param risultato risultato in DatiGenerazione
	 */
	public Test_session(DatiGenerazione risultato) {
		testElab = new BestPestElaborator(risultato.getLivMax(),risultato.getLivMin());
	}
