...
// BREAKOUT JSON EXAMPLE SETTINGS
	...
	/*
	 * 1^ elem: ball is colored? 1:true 0:false
	 * 2^ elem: paddle is colored? 1:true 0:false
	 * 3^ elem: bricks is colored? 1:true 0:false
	 * 4^ elem: obstacles is colored? 1:true 0:false
	 */
	/*public static String dynamicBall = "dynamicBall"; // ball changes or not the color during treatment
	public static String dynamicBar = "dynamicBar"; // bar changes or not the color during treatment
	public static String dynamicObstacles = "dynamicObstacles"; // bar changes or not the color during treatment
	public static String dynamicBricks = "dynamicBricks"; // bricks change or not the color during treatment
	*/
